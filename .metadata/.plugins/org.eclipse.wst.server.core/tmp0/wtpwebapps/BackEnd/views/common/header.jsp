							...
							<c:choose>
								<c:when test="${not empty sessionScope.currentUser}">
									...
									<li class="icon-notifications dropdown">
										<div class="icon badge position-relative" style="cursor:pointer;">
											<i class="fa fa-bell "  id="open-dropdown"   style="font-size:18px; color:#b7b7b7;" ></i>
											<div class="number position-absolute bg-danger badge text-white top-0"  id="open-dropdown" style="top:0;  cursor:pointer; ">
												new
											</div>
									...
									<script>
									    ...
									    function renderNotifications(notification) {
										    ...
										    $('.content-notification').append(notificationRow);
										}
									</script>
								</c:when>
								<c:otherwise>
