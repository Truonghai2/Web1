	...
	<div>
		...
		<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
			<ul id="sidebarnav">
				...
				<li class="sidebar-item"><a class="sidebar-link"
					href="moviedisabled" aria-expanded="false"> <span> <i
				...
				<li class="nav-small-cap"><i
						class="ti ti-dots nav-small-cap-icon fs-4"></i> <span
						class="hide-menu">QUẢN LÝ THÔNG BÁO</span></li>

				<li class="sidebar-item"><a class="sidebar-link"
											href="notifications" aria-expanded="false"> <span> <i
						class="ti ti-apps"></i>
					</span> <span class="hide-menu">Danh sách thông báo</span>
				</a></li>
				<li class="nav-small-cap"><i
					class="ti ti-dots nav-small-cap-icon fs-4"></i> <span
