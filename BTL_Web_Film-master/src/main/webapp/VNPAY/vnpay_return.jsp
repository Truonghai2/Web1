...
<%@page import="Controll.Service.Impl.MovieServiceImpl" %>
<%@page import="Controll.Service.MovieService" %>
<%@page import="Controll.Entity.Movie" %>
...
<%
    ...
    if (user != null) {
        ...
        //lấy ra được video
        Movie video = movieService.findByHref(href);
        ...
        if (video != null && user != null) {
            ...
            Hoadon hd = hoadonService.findHoaDonByUserIdAndMovieId(user.getId(), video.getId());
            if (hd != null) {
