...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<User> findUserLikedMovieByMovieId(Integer Id) {
		Map<String, Object> params = new HashMap<>();
		params.put("videoId", Id);
		return dao.findUserLikeByMovieId(params);
	}

	@Override
	public List<User> UserShareMovieById(Integer Id) {
		Map<String, Object> params = new HashMap<>();
		params.put("videoId", Id);
		return dao.UserShareMovieById(params);
	}

	@Override
	public List<User> UserPaymentVnpayById(Integer Id) {
		Map<String, Object> params = new HashMap<>();
		params.put("videoId", Id);
		return dao.UserPaymentVnpayById(params);
	}
